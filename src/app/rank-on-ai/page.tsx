...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Rank on AI Search — LLM Visibility | RankPilot',
...
export default function RankOnAIPage() {
  return (
    <>
                ...
                <ul className="mt-6 space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-sm text-muted">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#FF4757" strokeWidth="2" className="mt-0.5 flex-shrink-0">
            ...
            <ScrollReveal delay={0.15}>
              <div className="rounded-xl border border-electric/30 bg-navy/60 p-8">
                ...
                <p className="text-muted leading-relaxed">
                  ...
                  emerging channel. RankPilot&apos;s LLM Visibility Monitor gives you the tools to
                ...
                <ul className="mt-6 space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-sm text-muted">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#22D3A0" strokeWidth="2" className="mt-0.5 flex-shrink-0">
      ...
      {/* How RankPilot Helps — 3-Step Process */}
                    ...
                    <ul className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {step.details.map((detail) => (
                        <li key={detail} className="flex items-start gap-2 text-sm text-muted">
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#00D4FF" strokeWidth="2" className="mt-0.5 flex-shrink-0">
                            <polyline points="20 6 9 17 4 12" />
                          </svg>
                          {detail}
                        </li>
